...
export default function Footer() {
  const palavrasChave = [
    ...
    "Recarga Via E-mail", "Teste 3 dias",
    "Revendedor", "Recarga Imediata", "Promocao Unitv",
    "Unitv Anual", "Unitv Mensal", "Unitv Trimestral", "Unitv Semestral","AlphaPlay Menor Preço", "AlphaPlay Menor Valor", "Recarga Imediata", "Baixar AlphaPlay",
    ...
    <footer className="bg-(--cinza) py-16 px-[5%] text-center text-(--cor1)">
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mt-10 text-xs text-gray-600 max-w-[900px] mx-auto leading-relaxed">
          <p>
            A Ativação Imediata oferece <strong>códigos de recarga com ativação imediata</strong>, garantindo que você tenha acesso ao seu crédito em instantes. 
            Experimente a praticidade de recarregar rapidamente, com segurança e confiabilidade. 
            Nossos planos incluem opções mensais e anuais, oferecendo excelente custo-benefício para manter suas recargas sempre em dia.
            </p>
