...
export default function PlanoCard({
  ...
  return (
    <div className="bg-white p-8 rounded-2xl text-center transition-all duration-300 border border-gray-200 relative overflow-hidden hover:-translate-y-1 hover:shadow-2xl group">
      ...
      {/* Título */}
      <h3 className="text-xl font-bold mb-6 text-gray-900 uppercase tracking-wide">
        {titulo}
      </h3>
      ...
      <div className="bg-gray-50 rounded-xl p-6 mb-6">
        <ul className="list-none space-y-3 text-left">
          {features.map((feature, index) => (
            ...
            >
              <svg
                className="w-5 h-5 text-[#4F39F6] shrink-0 mt-0.5"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
      ...
      <div className="space-y-3">
        ...
        <a
          href="https://api.whatsapp.com/send?phone=5514998409433&text=Ol%C3%A1%2C%20gostaria%20de%20recarregar%20meu%20Aplicativo!"
          target="_blank"
